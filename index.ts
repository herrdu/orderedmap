...
export class OrderedMap {
  content: any;
  static from: (value: any) => OrderedMap;
  ...
  update(key: string, value: any, newKey?: string) {
  ...
  addBefore(place: string, key: string, value: any) {
  ...
  // order.
  forEach(f: (key: string, value: string) => void) {
  ...
  prepend(map: OrderedMap | { [key: string]: any }) {
  ...
  append(map: OrderedMap | { [key: string]: any }) {
    map = OrderedMap.from(map);
    if (!map.size) return this;
  ...
  // appear in `map`.
  subtract(map: OrderedMap | { [key: string]: any }) {
    var result: OrderedMap = this;
    map = OrderedMap.from(map);
...
OrderedMap.from = function (value: Object | OrderedMap) {
